...
import {ArrowIcon, XIcon, ZvanokIcon} from "@/src/icons/icon";
                        ...
                        <div className="pt-20 w-3/4 ml-24 bg-black flex items-center justify-center">
                            <div className="px-4">
                                <div className="flex text-white">
                                    <ZvanokIcon/>
                                    <Link className="ml-2.5 font-extrabold TT-ExtraBold text-sm" href="/">
                                        {t("ГЛАВНАЯ")}
                                    </Link>
                                </div>
                                <div className="flex text-white mt-7">
                                    <ZvanokIcon/>
                                    <Link className="ml-2.5 font-extrabold TT-ExtraBold text-sm" href="/AboutUs">
                                        {t("О КОМПАНИИ")}
                                    </Link>
                                </div>
                                <div className="flex text-white mt-7">
                                    <ZvanokIcon/>
                                    <Link className="ml-2.5 font-extrabold TT-ExtraBold text-sm" href="/OurServices">
                                        {t("НАШИ УСЛУГИ И КЕЙСЫ")}
                                    </Link>
                                </div>
                                <div className="flex text-white mt-7">
                                    <ZvanokIcon/>
                                    <Link className="ml-2.5 font-extrabold TT-ExtraBold text-sm" href="https://saidoff-akademiya.vercel.app/">
